...
/**
 * Compares one roommate description against multiple other descriptions. Other discripion are formate in [id, description]
 * @param {string} description1 - The first roommate description
 * @param {Array} descriptions - An array of other roommate descriptions
 * @returns {Array} An array of objects with the id and similarity score (id, similarity)
    */
